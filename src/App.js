...
export default class App extends Component {
  ...
  render() {
    return (
      ...
      />
      <Routes>
          <Route exact path="/technology" element={<News setProgress={this.setProgress} api={this.api} key="technology" pageSize={this.pageSize} country="in" category="technology"/>} />
